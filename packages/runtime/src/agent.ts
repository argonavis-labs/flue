...
export function createTaskTool(
	...
	return {
		...
		description:
			...
			'The task returns its final answer followed by a bracketed trace of the tool calls it made; a trace of "no tool calls" means the answer came from model recall, not research. ' +
